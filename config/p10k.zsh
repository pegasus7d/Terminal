# Generated by Powerlevel10k configuration wizard on 2025-06-10 at 20:32 IST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 13396.
# Wizard options: awesome-fontconfig, small icons, classic, ascii, darkest, 12h time,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    newline                 # put the prompt symbol on its own line
